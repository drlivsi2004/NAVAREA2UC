...
""",
    ...
    def test_windows_workflow_has_isolated_native_preview_smoke_gate(self):
        ...
        required_fragments = (
            ...
            "Copy-Item reports/corpus_differential_latest.json $sourceReportPath",
...
""",
    ...
    def test_discovers_all_navarea_sources_and_blocks(self):
...
""",
    ...
    def test_radius_warning_without_center_is_not_missing_circle(self):
        report = corpus_runner.run_corpus(ROOT, [ROOT / "NAV-V.txt"])
        targets = [
            message
    ...
    def test_fail_on_loss_gate_returns_blocking_status(self):
        status = corpus_runner.main_cli(
            [
                "--root",
                str(ROOT),
